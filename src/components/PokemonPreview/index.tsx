...
import { Spinner, Modal, ModalOverlay, ModalContent, ModalHeader, ModalCloseButton, ModalBody, ModalFooter, Button, useDisclosure } from "@chakra-ui/react"
    ...
    <Box>
      ...
      {!isLoading && data && (  
        <Box bg={'gray.700'} borderRadius={10} overflow={'hidden'}>
          <Flex bg={'primary.500'} w={'100%'} h={'60px'} flexDir={'column'} alignItems={'center'} position={'relative'}>
          ...
          <Flex p={4} mt={12} flexDir={'column'} alignItems={'center'} >
            <Text fontSize={'xl'} color={'primary.500'} textTransform={'uppercase'}>
              {data.name}
            </Text>
